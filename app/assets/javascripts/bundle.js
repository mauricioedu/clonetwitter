...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = function (_React$Component) {
	  ...
	  _createClass(Main, [{
	    key: "formattedTweests",
	    value: function formattedTweests(tweetsList) {
	    ...
	    value: function addTweet(tweetToAdd) {
	      ...
	      $.post("/tweets", { body: tweetToAdd }).success(function (savedTweet) {
	        ...
	        _this2.setState(_this2.formattedTweests(newTweetsList));
	    ...
	    value: function componentDidMount() {
	      ...
	      $.ajax("/tweets").success(function (data) {
	        return _this3.setState(_this3.formattedTweests(data));
	      }).error(function (error) {
	        return console.log(error);
	      });
	    }
